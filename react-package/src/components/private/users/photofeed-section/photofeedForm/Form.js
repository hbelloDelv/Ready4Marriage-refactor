...
import { FaUsers, FaMale, FaFemale, FaSearch} from "react-icons/fa";
import './photofeedForm.css';


function Form() {
    return (
        <div className="photofeedFormWrapper">
                 <div className="formContentPhotofeed">
                <form className="photofeedFormSection">
                    <div className="genderSection">
                        <div className="genderHeader">I'm looking for</div>
                        <div className="genderGrouping">
                            <div className="anyGender"> <FaUsers className="genderGroupingIcons"/> </div>
                            <div className="maleGender"> <FaMale className="genderGroupingIcons"/> </div>
                            <div className="femaleGender"> <FaFemale className="genderGroupingIcons"/> </div>
                        </div>
                    </div>
                    <div className="ageSection">
                        <div className="ageHeader">Aged</div>
                        <div className="ageGrouping">
                            <div className="form-group form-groupAge">
                                <input type="text" placeholder="From" className="form-control" style={{fontSize: "0.8rem"}}/>
                            </div>
                            <div className="form-group form-groupAgeMediaQuery">
                                <input type="text" placeholder="To" className="form-control" style={{fontSize: "0.8rem"}}/>
                            </div>
                            
                        </div>
                    </div>
                    <div className="locationSection">
                        <div className="locationHeader">Located</div>
                        <div className="locationGrouping">
                            <div className="form-group form-grouplocation">
                                <select name="nationality" className="form-group" id="selectBoxStyling">
                    ...
                    <div className="buttonSection">
                        <div className="buttonHeader" style={{color: "white", fontSize: "0.8rem"}}>Search</div>
                        <div className="buttonGrouping">
                            <div className="buttonDiv">
                                <button className="btn btn-primary w-100 searchButtonBgcolor"> <FaSearch /> Search</button>
                            </div>
                        </div>
                    </div>
                </form>
